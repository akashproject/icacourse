        ...
        <table class="content" width="600" cellpadding="0" cellspacing="0" border="0" style="background-color:#fff; border-radius:8px; overflow:hidden;">
          ...
          <tr>
            <td style="background-color:#007bff; padding:50px 20px; text-align:center;">
              ...
              <p style="color:#fff; font-size:14px; margin:0;"> Your transaction has been completed.</p>
            </td>
          </tr>
                ...
                <tr>
                  <td width="50%" valign="top" style="padding:10px;">
                    ...
                    <p style="font-size:13px; margin:0; line-height:18px;">
                      UNIT-1401, Eco Centre, Plot-04, BLOCK-EM, Sector V, Saltlake, Kolkata-700091, West bengal</p>
                      <p style="font-size:13px; margin:0; line-height:18px;">GSTIN : 19AABCI0017R1ZE</p>
                  ...
                  <td width="50%" valign="top" style="padding:10px; padding-top: 47px; text-align:right;">
                    ...
                    <p style="font-size:13px; margin:0; line-height:18px; text-align:right;">{{ $data['email']}}</p>
                    <p style="font-size:13px; margin:0; line-height:18px; text-align:right;">
                      {{ $data['address']}}, {{ $data['city']}}, <br>{{ $data['state_name']}}, {{ $data['pincode']}} 
                    </p>
                  </td>
                </tr>
              </table>
  ...
  <td style="padding:10px 20px;">
    <table width="100%" cellpadding="10" cellspacing="0" border="0" style="font-size:14px; color:#333; border-collapse:collapse;">
      ...
      <tr>
        ...
        <td style="border:none;">{{ $course['course'] }}</td>
        <td style="border:none; text-align:right;">₹{{ $course['amount'] }}/-</td>
      </tr>
      @endforeach
      <tr>
        <td style="border:none;"></td>
        <td style="border:none; text-align:right;" colspan="2"><strong style="font-weight: 700; margin-right: 50px;">Total Course Fees :</strong> ₹{{ $data['course_fee']}}/-</td>
      </tr>
      <tr>
        <td style="border:none;"></td>
        <td style="border:none; text-align:right;" colspan="2"><strong style="font-weight: 700; margin-right: 50px;">Discount :</strong> ₹{{ $data['discount']}}/-</td>
      </tr>
      <tr style="background:#e6edf9; font-weight:bold;">
        <td colspan="2" style="border:none; text-align:right;">Total Amount Paid :</td>
        <td style="border:none; text-align:right;">₹{{ $data['total']}}/-</td>
      </tr>
    </table>
  </td>
</tr>
          ...
          <tr>
            <td style="padding:20px; font-size:12px; color:#555; text-align:center;">
              ...
              <a href="#" style="color:#007bff; text-decoration:none;">T&C Apply</a>
              <br><br>
              <a href="#" style="display:inline-block; background-color:#007bff; color:#fff; font-weight:bold; padding:12px 20px; border-radius:6px; font-size:14px; text-decoration:none;">Download Course Guide</a>
              <br><br>
