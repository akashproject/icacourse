...
<footer class="footer bg-thm-color-one style_2 style_3" style="background-image:url(/assets/frontend/images/elements/element_18.png);">
    <div class="container">
                    ...
                    <div class="ft_widget ft_about xs-text-center">
                        ...
                        <ul class="info xs-text-center">
                            ...
                            <li>
                                ...
                                <a href="tel:+918100704872">+918100704872</a>
                            </li>
                            <li>
                                <i class="fal fa-envelope"></i>
                                <a target="_blank" href="mailto:online@icacourse.in">online@icacourse.in</a>
                            </li>
                        </ul>
                        <ul class="social xs-text-center">
                            <li>
        ...
        <div class="footer_bottom">
            <p class="mb-0">Copyright © 2025 All Rights Reserved, ICA EDU SKILLS</p>
        </div>
    </div>
</footer>