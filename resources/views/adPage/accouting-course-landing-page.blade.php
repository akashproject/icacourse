...
<body>
            ...
            <div class="row d-flex justify-content-between">
                <div class="col-lg-7">
                    <div class="my-4">
                        ...
                        <h2 class="mb-3">Develop Job-Ready Skills at your comfort</h2>
                        ...
                        <h4 class="text-assurance">Job Assurance, Short Term and Combo Courses are available</h4>
                        <div class="banner-line mb-4"></div>
                        <ul class="list-unstyled">
                            <li class="text-white"><i class="ri-graduation-cap-line text-warning mr-2"></i>For 12+ or Graduates or Professionals</li>
                            <li class="text-white"><i class="ri-graduation-cap-line text-warning mr-2"></i>Learn In English or Hindi</li>
                            <li class="text-white"><i class="ri-graduation-cap-line text-warning mr-2"></i>Courses: Beginners - Pro Level</li>
                            <li class="text-white"><i class="ri-graduation-cap-line text-warning mr-2"></i>Doubt Clearing Sessions</li>
                            <li class="text-white"><i class="ri-graduation-cap-line text-warning mr-2"></i>Live Projects</li>
                        </ul>
                            ...
                            <div class="col-lg-6">
                                <div class="review-section">
                                    <div class="review-bar mb-2">
                                        <h6 class="text-white d-inline me-3">Rating: 5</h6>
                                    ...
                                    <h6 class="text-white">11028 Votes | 13683 Enrolled</h6>
                                </div>
                            </div>
                        </div>

                        <h4 class="partner-heading">Authorised Training Partner of</h4>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="my-4 content-bar">
                        <h2 class="pre-heading">About Our Company</h2>
                        <h3 class="about-heading mb-4">ICA Edu Skills (since 1999) Online with 26 Years of Training Legacy</h3>

                        <h4><i class="fal fa-check-circle fs-5 mr-2"></i>100% Job Assurance Courses</h4>
                        <p>Enrolling in ICA Online brings you closer to your dream job as you get placed with 100% Job Assurance Courses.</p>

                        <h4><i class="fal fa-check-circle fs-5 mr-2"></i>Be Job Ready with Hands on Experience</h4>
                        <p>Learn in-demand Accounting & Finance skills and get hands on experience with 10 simulation software</p>

                        <h4><i class="fal fa-check-circle fs-5 mr-2"></i>Get Globally Recognized Certifications</h4>
                        <p>Be certified by the NSDC, SAP, Microsoft & ICA and accelerate your CV</p>

                        <h4><i class="fal fa-check-circle fs-5 mr-2"></i>National Placement Network Developing your Soft Skills</h4>
                        <p>Whether it's your resume, or preparing you for your interview, ICA Edu Skills is there to help you to get placed</p>
                        
                        <h4><i class="fal fa-check-circle fs-5 mr-2"></i>Be Mentored by Industry Leaders</h4>
                        <p>Learn with up to date course curriculum and get mentored by industry leaders</p>

                        <h4><i class="fal fa-check-circle fs-5 mr-2"></i>Career Path- Make the Right Choice!</h4>
                        <p>We provide our students with career counseling sessions to help them make the right career choice.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="my-4 text-center">
                        <h2 class="pre-heading">Course Gallery</h2>
                        <h3>Explore the Best Accounting Training Programs</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-between">
                <div class="col-lg-6">
                    <div class="my-4">
                        ...
                        <h4 class="mt-4"><i class="fal fa-check-circle fs-4 mr-2"></i>7 Simulation Softwares</h4>
    ...
    <div class="section testimonials-bar" id="testimonials">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="pre-heading mb-5">What Students Say</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4">
                    <div class="comment-bar">
                        <div class="comment-box">
                            ...
                            <p>Being an ICA’ian I have gone through the best online accounting training that makes me appear in the mock interviews confidently</p>
                        </div>
                        <div class="d-flex align-items-center profile-bar">
                            <div class="flex-shrink-0">
                                <img src="https://www.icacourse.in/wp-content/uploads/2022/02/ICA-course-page-img-6.png" alt="..." class="comment-profile">
                            </div>
                            <div class="flex-grow-1 ms-3">
                                <h5 class="profile-name">Debojyoti Bhattacharya</h5>
                                <p class="profile-course">Course : CIA</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="comment-bar">
                        <div class="comment-box">
                            ...
                            <p>I eternally advise everyone for ICA & its live & practical oriented accounts & finance training courses to manage a better career</p>
                        </div>
                        <div class="d-flex align-items-center profile-bar">
                            <div class="flex-shrink-0">
                                <img src="https://www.icacourse.in/wp-content/uploads/2022/02/ICA-course-page-img-4.png" alt="..." class="comment-profile">
                            </div>
                            <div class="flex-grow-1 ms-3">
                                <h5 class="profile-name">Ayushi Gupta</h5>
                                <p class="profile-course">Course : CIA</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="comment-bar">
                        <div class="comment-box">
                            ...
                            <p>It’s a great opportunity to get associated with ICA as I have learned the best of the Accounting & Finance modules online within a short time period…</p>
                        </div>
                        <div class="d-flex align-items-center profile-bar">
                            <div class="flex-shrink-0">
                                <img src="https://www.icacourse.in/wp-content/uploads/2022/02/ICA-course-page-img-3.png" alt="..." class="comment-profile">
                            </div>
                            <div class="flex-grow-1 ms-3">
                                <h5 class="profile-name">Pinakshi Deka</h5>
                                <p class="profile-course">Course : CIA</p>
                            </div>
                        </div>
                    </div>
