                        ...
                        <div class="sidebar">
                            <div class="info_widgets mt-5 text-center">
                                <div class="cart-button">
                                    ...
                                    @endphp
                                    <button class="{{$props}} add_to_cart_btn_{{ $contentMain->id }} border-4px-radious thm-btn bg-thm-color-three thm-color-three-shadow" style="background: #7129b5;" {{$props}}> Add to cart &nbsp;<i class="fal fa-shopping-bag"></i></button>
                                    @if(in_array('1',json_decode($contentMain->type_id))) 
                                        <div class="cart-button">
                                            <a href="{{ route('loan-check-eligibility',base64_encode($contentMain->id)) }}" class="border-4px-radious thm-btn bg-thm-color-three thm-color-three-shadow" > Check Loan Eligibility</a>
                                        </div>
                                    @endif
                                </div>
                                
                                <span class="division"> Or </span>
                                <a href="#lead-generate-popup" class="thm-btn bg-thm-color-two thm-color-two-shadow btn-rectangle open-popup-link"><i class="fal fa-phone mx-2"></i> Talk to our Expert </a>
                            </div>
                        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-5">
                    ...
                    <div class="text-center z-2 position-relative">
                        <a href="#lead-generate-popup" class="open-popup-link thm-btn bg-thm-color-two thm-color-two-shadow">
                            <i class="fal fa-phone mx-2"></i> Schedule An Appointment </a>
                    </div>
                </div>
            </div>
        </div>
